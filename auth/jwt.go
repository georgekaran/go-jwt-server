...
func (s *JWT) ValidateToken(tokenString string) (jwt.MapClaims, error) {
	// Make sure token is valid
	err := s.ValidSecret()
	if err != nil {
		return nil, err
...
// slice for safety.
func (s *JWT) SetSecret(secret []byte) {
...
//Credits: https://github.com/ImageWare/TLSential